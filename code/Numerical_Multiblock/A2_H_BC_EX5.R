...
n_test = 100
B = 3 # number of block 
omega = 0 # shrinkage factor (D=0: overlap, D=1/2: no overlap) -1/2 ~ 1/2
...
# save.image(file = paste0(rslt_path,"/H_BC_result_",naming,".RData"))
# load(file = paste0(rslt_path,"/H_BC_result_",naming,".RData"))

save.image(file = paste0("/root/capsule/results/H_BC_result_",naming,".RData"))
