function [tau,f_eval_F0] = back0(theta0,theta1,theta2,x0,x1,x2,noise0,noise1,noise2,case_no,f_eval_F0)
...
gF = gF0(x0,theta0,theta1,theta2);
f_eval_F0 = f_eval_F0 + 3; % one function eval + two function evals with h
...
c1 = 10^(-4);
alpha = alpha_bar;
while (F0(x0,theta0-alpha*gF,theta1,theta2,noise0) > F0(x0,theta0,theta1,theta2,noise0) - c1*alpha*gF^2)
    alpha = alpha*rho;
    f_eval_F0  = f_eval_F0 + 1;
end    
tau = alpha;
