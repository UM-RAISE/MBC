function [tau,f_eval_F1] = back1(theta0,theta1,theta2,x0,x1,x2,noise0,noise1,noise2,case_no,f_eval_F1)
...
gF = gF1(x1,theta0,theta1,theta2);
f_eval_F1 = f_eval_F1 + 3; % one function eval + two function with h eval
...
c1 = 10^(-4);
alpha = alpha_bar;
while (F1(x1,theta0,theta1-alpha*gF,theta2,noise1) > F1(x1,theta0,theta1,theta2,noise1) - c1*alpha*gF^2)
    alpha = alpha*rho;
    f_eval_F1  = f_eval_F1 + 1;
end    
tau = alpha;
